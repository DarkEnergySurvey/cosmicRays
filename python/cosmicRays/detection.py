...
import libcosmicRays.afw.detection as afwDet
...
class SourceDetectionConfig(pexConfig.Config):
    ...
    thresholdPolarity = chf.ChoiceField(
    ...
    background = cof.ConfigurableField(
        doc="Background re-estimation; ignored if reEstimateBackground false",
        target=SubtractBackgroundTask,
    )
    tempLocalBackground = cof.ConfigurableField(
    ...
    tempWideBackground = cof.ConfigurableField(
    ...
    **kwds
    ...
    def convolveImage(self, maskedImage, psf, doSmooth=True):
        ...
        if not doSmooth:
            ...
            return Struct(middle=middle, sigma=sigma)
    ...
    def applyThreshold(self, middle, bbox, factor=1.0):
        ...
        factor : `float`
            Multiplier for the configured threshold.
        """
        results = Struct(positive=None, negative=None, factor=factor)
